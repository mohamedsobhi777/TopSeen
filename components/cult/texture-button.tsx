...
const buttonVariantsOuter = cva("", {
  variants: {
    variant: {
      primary:
        "w-full border border-[1px] dark:border-[2px] border-black/10 dark:border-black bg-gradient-to-b from-black/70 to-black dark:from-primary/70 dark:to-primary/60 p-[1px] transition duration-300 ease-in-out ",
      accent:
...
const innerDivVariants = cva(
  "w-full h-full flex items-center justify-center text-muted-foreground",
  {
    variants: {
      variant: {
        primary:
          "gap-2 bg-gradient-to-b from-neutral-800 to-black  dark:from-primary dark:to-primary/80 text-sm text-white/90 dark:text-white transition duration-300 ease-in-out  hover:from-stone-800 hover:to-neutral-800/70 dark:hover:from-primary/90 dark:hover:to-primary/80 dark:active:from-primary/80 dark:active:primary/80 active:bg-gradient-to-b active:from-black active:to-black ",
      ...
      size: {
        xs: "text-xs rounded-[4px] px-0 py-1",
