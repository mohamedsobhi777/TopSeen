...
@media all and (-ms-high-contrast: none), (-ms-high-contrast: active) {
  ...
  .${className}::selection {
    background-color: #A2C2FD !important;
    color: transparent !important;
  }
}
`;
...
export default class Editor extends React.Component<Props, State> {
  ...
  render() {
    ...
    console.log(className + (textareaClassName ? ` ${textareaClassName}` : ""));

    return (
      <div
        {...rest}
        style={{ ...styles.container, ...style }}
        className=" p-0 overflow-hidden  min-h-[80px] w-full rounded-md border border-black/10 dark:border-white/10 bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-within:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
      >
        <pre
